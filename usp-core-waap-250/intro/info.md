...
> &#8987; Make sure to checkout the [manual configuration tuning scenario](../usp-core-waap-200) first prior to this one!

This scenario shows how to tackle **false positives** as a next step to the [manual configuration tuning scenario](../usp-core-waap-200) using the [auto-learning feature](https://united-security-providers.github.io/usp-core-waap/autolearning/).
