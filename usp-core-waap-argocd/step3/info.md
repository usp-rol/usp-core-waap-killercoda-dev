...
In the background a process is checking for rule exceptions every 10s not already known and will add them to the code repository **in a branch named autolearn-tool**. You can see / confirm a proposed config change by the Auto-Learning Tool within Gogs webUI and **after reviewing and accepting the pull request** changes will be applied by ArgoCD.

* [View proposed changes]({{TRAFFIC_HOST1_30080}}/gituser/testrepo/compare/main...autolearn-tool) (**click to open in new browser tab**)

> &#128270; If there are no changes recorded yet (you'll see a 404 message) then wait a couple of seconds and/or make sure to have access the Juiceshop application backend!
