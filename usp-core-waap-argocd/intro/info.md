...
This scenario shows how to seamlessly manage **Core WAAP** instances by leveraging **automation tools** like ArgoCD and git stored configuration. To get more background about USP Core WAAP head over to the [documentation](https://docs.united-security-providers.ch/usp-core-waap/latest/).
